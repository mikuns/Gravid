...
public class Settings extends PreferenceFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		String savedValue = listPref.getSharedPreferences().getString("avgCycle_pref",getString(R.string.pref_avg_cycle_summary));
		...
		final String savedWeight = weightEditTextPref.getSharedPreferences().getString("pre_weight", getString(R.string.pref_weight_def_summary));
